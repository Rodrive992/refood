...
// Breeze (login, register, logout, etc.)
    ...
    */
    Route::middleware(['role:admin'])
        ...
        */
        ...
        // ✅ Partial AJAX – pendientes
        Route::get('/caja/pendientes', [CajaController::class, 'pendientes'])
    ...
    /*
    |--------------------------------------------------------------------------
    | MOZO (y ADMIN si querés que también use POS)
    |--------------------------------------------------------------------------
    */
    Route::middleware(['role:mozo,admin'])
        ...
        */
        ...
        |--------------------------
        */
        Route::get('/dashboard/mesas', [MozoDashboardController::class, 'partialMesas'])
            ->name('dashboard.mesas');

        Route::get('/dashboard/comanda', [MozoDashboardController::class, 'partialComanda'])
            ->name('dashboard.comanda');

        Route::get('/dashboard/cuenta', [MozoDashboardController::class, 'partialCuenta'])
            ->name('dashboard.cuenta');

        /*
        |--------------------------
        | MESAS (acciones rápidas)
        |--------------------------
        */
        Route::post('/mesas/{mesa}/ocupar',   [MozoMesaController::class, 'ocupar'])->name('mesas.ocupar');
        Route::post('/mesas/{mesa}/reservar', [MozoMesaController::class, 'reservar'])->name('mesas.reservar');
