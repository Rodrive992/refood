...
Route::middleware(['auth'])->group(function () {
    ...
    */
    Route::middleware(['role:admin'])
        ...
        // ✅ CORREGIDO: ahora son PATCH (coincide con @method('PATCH'))
        ...
        Route::get('/historial', [CajaHistorialController::class, 'index'])->name('caja.historial.index');
