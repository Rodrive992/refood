{{-- resources/views/mozo/modals/cuenta.blade.php --}}
<div id="modalSolicitarCuenta"
     class="rf-modal-backdrop fixed inset-0 z-50 hidden items-center justify-center p-4 bg-black/50">
    ...
    <div class="bg-white rounded-2xl w-full max-w-md shadow-2xl animate-fade-in overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-200 flex items-center justify-between bg-gradient-to-r from-green-50 to-white">
            <div>
                ...
                <div id="modalSolicitarCuentaTitle" class="text-xl font-bold text-gray-900">
                    Mesa — · #—
                </div>
            </div>
        ...
        <form id="modalSolicitarCuentaForm" method="POST" action="" class="p-6">
            @csrf

            <div class="mb-6 p-4 bg-gray-50 rounded-xl">
                <div class="text-center">
                    <div class="text-xs text-gray-500 mb-1">Total estimado</div>
                    <div class="text-3xl font-bold text-gray-900" id="modalSolicitarCuentaSubtotal">
                        $ 0
                    </div>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea id="modalSolicitarCuentaNota"
                          name="nota"
                          rows="3"
